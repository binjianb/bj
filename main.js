...
$.post("c.php", {query_id: robot,hastle:hastle}, function (data) {
        ...
        var json = data.msg;
            ...
            if ( data.code == 0) {
                element = '<div id="c"><img src="assets/ok.png" />&nbsp;&nbsp;该QQ为正版授权</div>';
            }else if(data.code == 2){
                element = '<div id="c"><img src="assets/no.png" />&nbsp;&nbsp;该QQ为试用授权</div>';
			}else if(data.code == -8){
                window.location.reload();
			}else if(data.code == -1){
                element = '<div id="d"><img src="assets/no.png" />&nbsp;&nbsp;该QQ并没有授权</div>';
			}
...
function daili() {
    ...
    $.post("d.php", {query_id: robot_dl,hastle:hastle}, function (data) {
        ...
        //$.Confirm(' ', element_div+data.msg, 1);
            if ( data.code == 0) {
                element = '<div id="c"><img src="assets/ok.png" />&nbsp;&nbsp;'+json+'</div>';
            }else if(data.code == -1){
                element = '<div id="d"><img src="assets/no.png" />&nbsp;&nbsp;该QQ不是代理</div>';
			}else if(data.code == -8){
                window.location.reload();
			}else if(data.code == -3){
                element = '<div id="d"><img src="assets/no.png" />&nbsp;&nbsp;'+data.msg+'</div>';
			}
